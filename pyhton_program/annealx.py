...
# [destinasi, (lot,lan), tarif, rating, durasi, open, close]    
	...
	post2 = [
				['tangkuban perahu 1',20000,3.5,7200,8,17],
				['maribaya hot spring 1',35000,4,10800,8,10],
				['situ cuburuy 1',20000,3,0,0,24],
				['observatorium bosscha 1',15000,4,0,7,19],
				['Gua sanghyang Tikoro 1',0,0,0,0,24],
				['Stone Garden Geo Park 1',3000,3.5,7200,0,24],
				['air terjun maribaya 1',7500,4,0,8,18],
				['Taman Begonia',10000,4,10800,7,17],
				['taman hutan raya irjuanda 1',11000,4,7200,0,24],
				['curug cimahi 1',12000,4,3600,0,24],
			]
cities = [
